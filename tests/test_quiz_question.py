"""Tests for the QuizQuestion class in the slido_quiz_bot module.

This file contains unit tests for the QuizQuestion class. It includes tests to validate the
creation and attributes of QuizQuestion instances, as well as tests for the validity of the
answer choices and correct_answer_index for each question.
"""
