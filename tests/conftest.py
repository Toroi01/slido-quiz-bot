"""Conftest file for the Slido Quiz Bot test suite.

This module contains common test fixtures and configuration for the Slido Quiz Bot project tests.
Fixtures defined here are shared across test modules, providing reusable setup for tests.
"""
